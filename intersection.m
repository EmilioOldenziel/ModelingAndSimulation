classdef intersection
    ...
    methods
        function obj = intersection(green_mode, lock_mode)
            ...
            if obj.lock_mode == 1
                if obj.lock <= 0 && obj.car_lock_1 <= 0 && obj.car_lock_2 <= 0 
                    if obj.green_mode == 1
                        ...
                        obj.on_green = mod(obj.on_green+1, 4);
                    end 
                    switch obj.on_green 
                        case 1
               ...
               if obj.car_lock_1 <= 0 && obj.car_lock_2 <= 0
                    if obj.green_mode == 1 
                        waiting_times = [...
                            max(obj.north.get_longest_waiting_time_right(i), obj.south.get_longest_waiting_time_right(i)) ... % north-south straight and right turns
                            max(obj.east.get_longest_waiting_time_right(i), obj.west.get_longest_waiting_time_right(i)) ...   % east-west straight and right turns
              ...
              waiting_times = [...
                ...
                if obj.car_lock_1 > 0
                   obj.car_lock_1 = obj.car_lock_1 - 1;
                end
                if obj.car_lock_2  > 0 
                    obj.car_lock_2 = obj.car_lock_2 - 1;
                end 
